...
export default async function handler(
    ...
    try {
        ...
        const timeoutId = setTimeout(() => controller.abort(), 55000); // 55 seconds (slightly less than client timeout)
        ...
        try {
            ...
            if (fetchError instanceof Error && fetchError.name === 'AbortError') {
                ...
                return res.status(408).json({
                    ...
                    message: 'The insurance details API took too long to respond. Please try again.',
                });
            }
