        ...
        <div className="mb-6">
          ...
          {pollingAttempts > 0 && status !== "complete" && (
            <div className="flex justify-between text-sm text-gray-600">
              <span>
                Checking status... (Attempt {pollingAttempts}/{maxAttempts})
              </span>
            ...
            <div className="flex gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-yellow-800">
                  Your eligibility check is in the queue and will begin
                  processing shortly. This typically takes 30-90 seconds.
                </p>
              </div>
            </div>
          </div>
