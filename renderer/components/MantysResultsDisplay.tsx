    ...
    try {
      ...
      if (selectedNetwork) {
        const networkFromMantys = data.policy_network?.all_networks?.find(
          (n: any) =>
            n.network_value === selectedNetwork ||
            n.network === selectedNetwork,
        );
        networkIdToUse =
          networkFromMantys?.network ||
          data.policy_network?.network_id ||
          selectedNetwork;
      }
      ...
      const policyData = {
        ...
        planName:
          selectedPlan?.insurance_plan_name ||
          data.patient_info?.plan_name ||
          null,
